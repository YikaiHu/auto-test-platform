...
export interface SpecifyOSClusterProps<ST extends ParticalServiceType> {
  taskType: ServiceLogType;
  hidePageTitle?: boolean;
  pipelineTask: ST;
  ...
  setDomainCheckStatus: React.Dispatch<React.SetStateAction<DomainStatusCheckResponse | undefined>>;
}

export function SpecifyOSCluster<ST extends ParticalServiceType>(props: SpecifyOSClusterProps<ST>) {
  return <SpecifyOpenSearchCluster
    {...props}
