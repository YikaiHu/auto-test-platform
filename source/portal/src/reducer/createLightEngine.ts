...
const validateLogArchiveSchedule = withI18nErrorMessage(
  validateRequiredText(
    "lightengine:engine.create.errorLogArchiveScheduleMissing"
  )
);
const validateLogMergerSchedule = withI18nErrorMessage(
  validateRequiredText(
    "lightengine:engine.create.errorLogMergerScheduleMissing"
  )
);
